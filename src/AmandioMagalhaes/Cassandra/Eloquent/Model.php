...
namespace AmandioMagalhaes\Cassandra\Eloquent;

use Carbon\Carbon;
use DateTime;
use Illuminate\Database\Eloquent\Model as BaseModel;
use Illuminate\Database\Eloquent\Relations\Relation;
use AmandioMagalhaes\Cassandra\Query\Builder as QueryBuilder;
use AmandioMagalhaes\Cassandra\Relations\EmbedsMany;
use AmandioMagalhaes\Cassandra\Relations\EmbedsOne;
use AmandioMagalhaes\Cassandra\Relations\EmbedsOneOrMany;
...
abstract class Model extends BaseModel
{
     ...
     * @return \AmandioMagalhaes\Cassandra\Relations\EmbedsMany
     */
     ...
     * @param  string  $foreignKey
     * @param  string  $relation
     * @return \AmandioMagalhaes\Cassandra\Relations\EmbedsOne
     */
     ...
     *
     * @param  \AmandioMagalhaes\Cassandra\Query\Builder $query
     * @return \AmandioMagalhaes\Cassandra\Eloquent\Builder|static
     */
